...
<head>
  ...
  <style>
    body {
      margin: 0;
      height: 100vh;
      background-color: #121212; /* fond noir doux */
      display: flex;
    ...
    .container {
      text-align: center;
      background-color: #283593; /* bleu indigo principal */
      border-radius: 16px;
      padding: 40px 30px;
    ...
    .progress {
      height: 100%;
      width: 0;
      background: linear-gradient(90deg, #5c6bc0, #283593); /* dégradé bleu clair à foncé */
    ...
    .percentage {
      ...
      color: #B0B0B0; /* gris moyen pour texte secondaire */
